    ...
    <section id="form" class="flex flex-col-reverse lg:flex-row max-w-6xl mx-auto mb-25 border border-gray-300/40 rounded-xl shadow overflow-hidden">
        <div class="flex flex-col w-full lg:w-1/2 border-t lg:border-t-0 lg:border-r border-gray-400/30 py-10">
            ...
            <form ref="contactForm" @submit.prevent="sendEmail" class="flex flex-col gap-5 px-10">
                <FormField v-model="formData.from_name" label="Nome" id="nome" name="from_name" :maxlength="100" />
                
                <FormField v-model="formData.reply_to" label="E-mail" id="email" name="reply_to" type="email" :maxlength="254" />
                ...
                <FormField v-model="formData.subject" label="Assunto" id="assunto" name="subject" :maxlength="150" />

                <FormTextarea v-model="formData.message" label="Mensagem" id="mensagem" name="message" :maxlength="2000" />
